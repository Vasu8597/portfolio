        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                {personalInfo.role} with {personalInfo.experience} of experience building modern web applications.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/projects" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors text-sm">
                    Projects
                  </Link>
                </li>
                <li>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="p-2 bg-gray-200 dark:bg-gray-800 rounded-lg hover:bg-primary-600 hover:text-white dark:hover:bg-primary-600 transition-colors text-gray-700 dark:text-gray-300"
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                © {currentYear} Vasu Kaneriya. All rights reserved.
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
